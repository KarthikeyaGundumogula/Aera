...
export const TheatrePage = lazy(() =>
  import("@/features/theatre/TheatrePage").then((m) => ({
    default: m.TheatrePage,
  })),
);
...
export const OriginalsListPage = lazy(() =>
  import("@/features/originals/OriginalsListPage").then((m) => ({
    default: m.OriginalsListPage,
  })),
);

export const OriginalPage = lazy(() =>
  import("@/features/originals/OriginalPage").then((m) => ({
    default: m.OriginalPage,
  })),
);
...
export const FestivalDetailPage = lazy(() =>
  import("@/features/festivals").then((m) => ({
    default: m.FestivalDetailPage,
  })),
);
