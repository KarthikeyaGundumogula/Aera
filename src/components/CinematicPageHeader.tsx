...
export function CinematicPageHeader({
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-[100] px-4 md:px-6 py-4 flex items-center justify-between bg-surface-deep/80 backdrop-blur-md border-b border-white/5 ${className}`}
    >
      {/* Left: Back button */}
