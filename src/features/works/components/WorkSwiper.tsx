        ...
        <AnimatePresence>
          {showSwipeHint && feedContext.length > 1 && (
            ...
            >
              ...
              >
                <div className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/10 border border-white/10 backdrop-blur-md shadow-2xl">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                  <span className="text-[9px] font-bold uppercase tracking-[0.2em] text-white/90">Discover</span>
