  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative w-full max-w-2xl bg-[#0a0a0a] border border-white/10 rounded-[32px] overflow-hidden flex flex-col max-h-[90vh] shadow-[0_30px_100px_rgba(0,0,0,0.8)]"
                      ...
                      >
                        <div className="w-8 h-8 rounded-lg bg-white/10 overflow-hidden flex-shrink-0">
                          {person.profilePicture ? (
                            <img src={person.profilePicture} alt={person.actorName} className="w-full h-full object-cover" />
                          ) : (
