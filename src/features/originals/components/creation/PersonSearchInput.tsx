          ...
          <AnimatePresence>
            {showDropdown && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: 4 }}
                className="absolute left-0 right-0 top-full mt-2 z-50 rounded-xl border border-white/10 bg-[#0a0a0a] backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.6)] overflow-hidden"
              >
                {allResults.length > 0 && (
