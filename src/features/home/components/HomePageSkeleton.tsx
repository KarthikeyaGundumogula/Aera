...
export function HomePageSkeleton() {
  return (
    <div className="bg-[#050505] min-h-screen text-white pb-24">
      {/* Header skeleton */}
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 bg-black/40 backdrop-blur-xl border-b border-white/5 md:px-8 md:py-6">
