      ...
      >
        ...
        {onImagePositionChange && (
          <div className="absolute right-12 top-1/2 -translate-y-1/2 z-50 flex flex-col items-center gap-4 opacity-40 hover:opacity-100 transition-opacity">
            <span className="text-[8px] font-black uppercase tracking-widest text-white/30 [writing-mode:vertical-rl]">PAN Y</span>
            <input 
        ...
        {onImagePositionChange && (
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-50 flex items-center gap-4 opacity-40 hover:opacity-100 transition-opacity">
            <span className="text-[8px] font-black uppercase tracking-widest text-white/30">PAN X</span>
            <input 
              type="range" min="0" max="100" 
        ...
        {onTextColorChange && (
          <div className="absolute top-[8%] right-[14%] md:right-[20%] z-50 flex items-center gap-4">
            <div className="relative">
              ...
              >
                <div className="w-4 h-4 rounded-full border border-white/40 shadow-[0_0_10px_rgba(255,255,255,0.3)]" style={{ backgroundColor: themeTextColor }} />
              </motion.button>
              {activePicker === 'text' && (
          ...
          <div className="absolute bottom-12 right-12 z-50 flex items-center gap-4">
            <div className="relative">
              <motion.button 
                ...
                className="flex items-center justify-center w-10 h-10 rounded-full bg-black/40 backdrop-blur-md border border-white/20 hover:border-white/50 transition-all z-10"
              >
                <div className="w-4 h-4 rounded-full border border-white/40 shadow-[0_0_10px_rgba(255,255,255,0.2)]" style={{ backgroundColor: themeBgColor }} />
              </motion.button>
              {activePicker === 'bg' && (
                <div className="absolute bottom-12 right-0 p-3 rounded-2xl bg-black/80 backdrop-blur-xl border border-white/20 shadow-2xl z-50 origin-bottom-right animate-in fade-in zoom-in-95 duration-200">
