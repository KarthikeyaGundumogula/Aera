...
export const mockLibrary: LibraryItem[] = [
  ...
  },
  {
    ...
    status: "watched",
    hypeText:
      "The legendary team up of Ram and Bheem. The edits have me hyped for the interval sequence.",
    afterThoughts:
  ...
  },
  {
    ...
    status: "want_to_watch",
    hypeText:
      "Rocky Bhai's empire. The sheer scale and swagger in these edits is unmatched.",
    taggedWorks: [
      {
        id: "w-kgf-1",
        type: "hype_cut",
