...
import { Recommendation, MOCK_RECOMMENDATIONS } from "./recommendations";
import { Original } from "../types/originals";
import { GRID_ITEMS } from "./index";
...
export const INITIAL_SAVED_ITEMS: SavedItemEntry[] = [
  {
    ...
    resolvedWork: GRID_ITEMS.find((w) => w.id === "w-kgf-1") as TheatreItem,
  ...
  },
  {
    ...
    resolvedWork: GRID_ITEMS.find((w) => w.id === "w-og-1") as TheatreItem,
  ...
  },
  {
    ...
    resolvedWork: GRID_ITEMS.find((w) => w.id === "w-rrr-1") as TheatreItem,
